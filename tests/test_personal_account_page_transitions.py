...
class TestAccountTransitions:
    ...
    def test_open_account_successful(self, driver, log_in):
    ...
    def test_click_constructor_successful(self, driver, log_in):
    ...
    def test_click_logo_successful(self, driver, log_in):
        driver.find_element(*Locators.PERSONAL_ACCOUNT_BTN).click()
